  ...
  container[audiojs] = {
    ...
    settings: {
      ...
      css: '\
        ...
        \
        .audiojs .play { background: url("$1") 0 0 no-repeat; } \
        .audiojs .loading { background: url("$1") 0 -50px no-repeat; } \
        .audiojs .error { background: url("$1") 0 -50px no-repeat; } \
        .audiojs .pause { background: url("$1") 0 -100px no-repeat; } \
        \
    ...
    createAll: function(options, elements) {
      $("audiojs").detach();
      $('<audio preload></audio>').appendTo(".music-skandal-player");
